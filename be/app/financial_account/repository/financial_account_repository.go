...
type IFinancialAccountRepository interface {
	CreateFinancialAccount(id string, dto financial_account.CreateFinancialAccountDto) (*domain.FinancialAccount, error)
	GetFinancialAccount(id string) (*[]domain.FinancialAccount, error)
}
...
func NewFinancialAccountRepository() IFinancialAccountRepository {
